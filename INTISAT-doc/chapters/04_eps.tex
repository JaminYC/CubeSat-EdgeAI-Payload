...
El subsistema de control de Electricidad Térmica y Potencia (EPS, Electrical Power System) es el encargado primario de tres misiones en órbita LEO: recolección energética celular, protección temporal/almacenamiento mediante celdas de batería y acondicionamiento y distribución segura a todo el bus de carga. Adicionalmente, el EPS orquesta indirectamente la vida del satélite al controlar los interruptores principales (Kill-Switches).
...
\begin{itemize}
    \item \textbf{Celdas:} Compuesto por celdas robustas de Ion Lítio integradas en serie/paralelo (formato 18650), con protección de calentadores térmicos internos para sobrepasar los eclipses orbitales LEO sin congelar los electrolitos.
